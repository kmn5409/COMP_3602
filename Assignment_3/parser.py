...
def main():
    ...
    if debug:
        try:
            ...
            print("This is the LOLCODE you entered: \n", content)
            print("\n")
        ...
        print("You need to enter debug mode to parse your LOLCODE. \n"
              "Try adding '-debug' to the end of your command to run the parser program.")
